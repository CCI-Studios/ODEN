...
class DisableMessagesSettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['disable_messages_filter_options']['role_information'] = array(
      ...
      '#markup' => $this->t('By default, permission to view all message types are given for all roles. You can change this in @link to limit the roles which can view a given message type.', array('@link' => $this->l($this->t('administer permissions'), Url::fromRoute('user.admin_permissions')))),
    );
    $options = array(
